...
def get_live_traffic(_engine: MapplsTrafficEngine, o_lat, o_lon, d_lat, d_lon):
...
api_key = st.sidebar.text_input(
    "Mappls API Key (optional)",
    type="password",
    help="Leave empty to use MAPPLS_API_KEY from the environment, or the local heuristic simulator if neither is set.",
)
...
# LIVE DATA
# ==========================================
traffic_engine = MapplsTrafficEngine(api_key=api_key or None)
